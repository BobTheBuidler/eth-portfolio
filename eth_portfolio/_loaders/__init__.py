...
The functions imported here are designed to facilitate the retrieval and processing of Ethereum blockchain data, 
enabling efficient data handling and storage for portfolio analysis.
...
Examples:
    Basic usage of the imported functions can be seen in the following examples:

    >>> from eth_portfolio._loaders import load_transaction
