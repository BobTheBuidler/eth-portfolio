...
PyInit_balances(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_eth_portfolio____loaders___balances");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "eth_portfolio__mypyc.init_eth_portfolio____loaders___balances");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
