...
PyInit__nonce(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_eth_portfolio____loaders____nonce");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "eth_portfolio__mypyc.init_eth_portfolio____loaders____nonce");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit__nonce(); }
