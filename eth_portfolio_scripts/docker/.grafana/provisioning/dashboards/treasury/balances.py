      ...
      "panels": [
        {
          ...
          "targets": [
            {
              "exemplar": true,
              "expr": "sum(my_portfolio_assets{param=\"usd value\",bucket=\"Other short term assets\"}) by (token)",
              "hide": false,
              "interval": "",
              "legendFormat": "{{token}}",
              "refId": "A"
      ...
      "panels": [
        {
          ...
          "targets": [
            {
              "exemplar": true,
              "expr": "sum(my_portfolio_assets{param=\"usd value\",bucket=\"Other short term assets\"}) by (token, wallet)",
              "hide": false,
              "interval": "",
              "legendFormat": "{{token}} | {{wallet}}",
              "refId": "A"
      ...
      "transformations": [
        ...
        },
        {
          ...
          "options": {
            ...
            "indexByName": {},
            "renameByName": {
              "Value #A (first)": "Period Start Value ($)",
              "Value #A (last)": "Period End Value ($)",
              "__name__": "Label",
              "bucket": "Bucket",
              "param": "",
              "token": "Token"
        ...
        },
        {
          ...
          "options": {
            "alias": "+/-",
            "binary": {
              "left": "Period End Value ($)",
              "operator": "-",
              "reducer": "sum",
              "right": "Period Start Value ($)"
            },
            "mode": "binary",
            "reduce": {
              "reducer": "sum"
