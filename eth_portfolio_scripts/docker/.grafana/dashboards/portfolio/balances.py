{
    ...
    "panels": [
        ...
        {
            "datasource": {"type": "prometheus", "uid": "PBFE396EC0B189D67"},
            "fieldConfig": {
                "defaults": {
                    "color": {"mode": "thresholds"},
            ...
            "gridPos": {"h": 13, "w": 24, "x": 0, "y": 24},
            "id": 51,
            "options": {
                "footer": {"fields": "", "reducer": ["sum"], "show": false},
                "frameIndex": 0,
                "showHeader": true,
                "sortBy": [{"desc": true, "displayName": "Period End Value ($)"}],
            },
            "pluginVersion": "8.3.1",
            "targets": [
                {
            ...
            "transformations": [
                {
                    ...
                    "options": {
                        "filters": [
                            {
                                "config": {"id": "equal", "options": {"value": "usd value"}},
                                "fieldName": "param",
                            }
                        ],
                        "match": "any",
                ...
                },
                {
                    ...
                    "options": {
                        "fields": {
                            ...
                            "__name__": {"aggregations": [], "operation": "groupby"},
                            "balance": {"aggregations": []},
                            "bucket": {"aggregations": [], "operation": "groupby"},
                            "network": {"aggregations": []},
                            "param": {"aggregations": []},
                            "token": {"aggregations": [], "operation": "groupby"},
                            "usd value": {
