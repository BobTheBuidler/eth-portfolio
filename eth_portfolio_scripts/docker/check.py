...
def check_docker() -> None:
    ...
    try:
        ...
        raise RuntimeError('Docker is not installed. You must install Docker before using dao-treasury.') from None
...
def check_docker_compose() -> None:
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError('Docker Compose is not installed. You must install Docker Compose before using dao-treasury.') from None
